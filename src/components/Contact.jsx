...
const Contact = () => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "936ec7a5-c602-4e8a-8693-652b8d1b38a2");
  ...
  return (
    ...
    className='text-center p-6 py-20 lg:px-32 w-full overflow-hidden' id='Contact'>
         ...
         <form onSubmit={onSubmit} className='max-w-2xl mx-auto text-gray-600 pt-8'>
            ...
            <button className='bg-blue-600 text-white py-2 px-12 rounded hover:bg-blue-600' type='submit'>{result ? result: "Send Message"}</button>
         </form>
